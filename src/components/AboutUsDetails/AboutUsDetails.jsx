    ...
    <main className="w-full flex flex-wrap  justify-between md:justify-between mt-10 p-4 md:p-8 ">
      <div className="mt-8 w-full md:w-1/2 mb-4 md:mb-0 flex flex-col px-3">
        ...
        <p className="text-sm pt-2 leading-[1.8] text-left text-justify  text-primary">
          At Zima Immobilier, our mission is to empower individuals, families, and investors to
      ...
      <div className="mt-8 w-full md:w-1/2 mb-4 md:mb-0 flex flex-col px-3">
        ...
        <p className="text-sm pt-2 leading-[1.8] text-left text-justify text-primary">
          Our vision at Zima Immobilier is to redefine the real estate investment experience,
      ...
      <div className="mt-8 w-full md:w-1/2 mb-4 md:mb-0 flex flex-col px-3">
        ...
        <p className="text-sm pt-2 leading-[1.8] text-left text-justify text-primary">
          Backed by a team of seasoned real estate professionals, Zima Immobilier harnesses the
