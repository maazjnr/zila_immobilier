...
import { GrLocationPin, GrStatusInfo } from "react-icons/gr";
    ...
    <main className="w-full">
      ...
      <section className="w-full flex flex-col md:flex-row items-center justify-around p-5 md:py-10">
        <div className="text-sm text-justify mb-5 md:mb-0 md:mr-10">
          ...
          <h1 className="md:max-w-3xl">
            Discover this exquisite 4-bedroom luxury apartment in the heart of
            Kensington, London. Situated in one of the city’s most prestigious
            neighbourhoods, the property offers a blend of elegance and modern
            living. Features include a rooftop terrace with panoramic views of
            London, a private gym, swimming pool, 24/7 concierge service, high-speed
            internet, and secure underground parking.
          </h1>

          <h1 className="text-secondaryx bg-primary p-3 rounded text-left text-1xl py-5 font-primary font-normal mb-3 mt-3">
            Price: <span className="text-[#fff]">£2.5 Million</span>
          </h1>
        </div>
        ...
        <div className="p-5 bg-white rounded-lg mt-7 shadow-lg">
          <div className="flex flex-wrap items-center mb-3">
            ...
            <p className="ml-2 font-primary text-sm">
              21 Cromwell Road, Kensington, London, UK
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center mb-3">
            ...
            <div className="flex items-center mr-6 mb-2">
              <IoIosBed className="text-secondaryx" size={18} />
              <p className="ml-2 font-primary text-[#aeaeae]">3 Bathrooms</p>
            </div>
          ...
          <div className="flex flex-wrap items-center mb-3">
            ...
            <div className="flex items-center mr-6 mb-2">
              ...
              <p className="ml-2 font-primary text-[#aeaeae]">Land Size: 350 sqm</p>
            </div>

            <div className="flex items-center mr-6 mb-2 mt-1">
              <PiIdentificationCardLight className="text-secondaryx" size={20} />
              <p className="ml-2 font-primary text-[#aeaeae]">
                Property ID: LDN102938
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center mb-3">
            ...
            <div className="flex items-center mr-6 mb-2">
              ...
              <p className="ml-2 font-primary text-[#aeaeae]">Status: Active</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="w-full p-5 flex flex-wrap items-center md:space-x-5 ">
        ...
        <button className="bg-primary p-3 text-secondary space-x-2 flex flex-row items-center rounded my-2">
          <PiPhoneCallThin size={24} /> <p>+44 7440 633 566</p>
        </button>
      </div>
    </main>
  );
